      ...
      <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
          <a
            ...
            href="#"
          >
            <img src="pi.png" alt="" style={styles_logo} />
          </a>
        ...
        <div class="carousel-inner">
            ...
            <div class="container">
              <div class="row p-5">
                <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                  <img class="img-fluid" src="gpu.png" alt="" />
                </div>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="row p-5">
                <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                  <img class="img-fluid" src="cpu.png" alt="" />
                </div>
                <div class="col-lg-6 mb-0 d-flex align-items-center">
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="row p-5">
                <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                  <img class="img-fluid" src="monitor.png" alt="" />
                </div>
                <div class="col-lg-6 mb-0 d-flex align-items-center">
                  <div class="text-align-left">
                    <h1 class="h1">Lorem Ipsum</h1>
      ...
      <section class="container py-5">
        ...
        <div class="row">
          <div class="col-12 col-md-4 p-5 mt-3">
            <a href="#">
              <img
                src="keyboard-mouse.png"
                class="rounded-circle img-fluid border"
              />
            </a>
            <h5 class="text-center mt-3 mb-3">Keyboard & Mouse</h5>
            <p class="text-center">
          ...
          <div class="col-12 col-md-4 p-5 mt-3">
            <a href="#">
              <img src="speaker.png" class="rounded-circle img-fluid border" />
            </a>
            <h2 class="h5 text-center mt-3 mb-3">Speakers</h2>
            <p class="text-center">
              <a class="btn btn-success">Go Shop</a>
            </p>
          </div>
